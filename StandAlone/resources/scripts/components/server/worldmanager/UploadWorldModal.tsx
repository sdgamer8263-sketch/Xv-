...
export default ({ visible, worldName, onDismissed, onUploaded }: Props) => {
    ...
    return (
        <Modal
            ...
            showSpinnerOverlay={uploading}
        >
            <h2 css={tw`text-2xl mb-2 text-neutral-100`}>Replace World</h2>
