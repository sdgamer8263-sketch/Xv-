...
export default () => {
    ...
    const changeEgg = () => {
        ...
        setTimeout(() => {
            addFlash({ key: 'egg-changer', type: 'success', message: 'Egg change request submitted successfully!' });
                ...
                <TitledGreyBox title={'Change Server Environment'} icon={SwitchVerticalIcon}>
                    <div css={tw`mb-6`}>
                        <p css={tw`text-sm text-neutral-300`}>
                            Select a new environment (Egg) for your server. <b css={tw`text-red-400`}>Warning:</b> Changing the egg might require a server reinstall and could affect your files.
                        </p>
                    </div>
                ...
                <TitledGreyBox title={'Information'} icon={InformationCircleIcon}>
                    <div css={tw`flex flex-col gap-4 text-sm text-neutral-300`}>
                        <p>
                            ...
                            An Egg defines the environment your server runs in, handling startup commands and Docker images.
                        </p>
                        <p>
                            <strong css={tw`text-neutral-100`}>Important Note:</strong><br/>
                            Always create a backup before switching your server egg to prevent data loss.
                        </p>
                    </div>
                </TitledGreyBox>
            </div>
