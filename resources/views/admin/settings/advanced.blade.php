                            ...
                            <div class="form-group col-md-6">
                                ...
                                <div>
                                    <select class="form-control" name="recaptcha:method">
                                        <option value="recaptcha" @if(old('recaptcha:method', DB::table('settings')->where('key', 'settings::recaptcha:method')->value('value') ?? 'recaptcha') == 'recaptcha') selected @endif>Google reCAPTCHA</option>
                                        <option value="turnstile" @if(old('recaptcha:method', DB::table('settings')->where('key', 'settings::recaptcha:method')->value('value') ?? 'recaptcha') == 'turnstile') selected @endif>Cloudflare Turnstile</option>
                                    </select>
