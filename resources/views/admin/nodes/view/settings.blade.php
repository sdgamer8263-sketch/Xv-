        ...
        <div class="col-sm-6">
            <div class="box">
                ...
                <div class="box-body row">
                    ...
                    <div class="form-group col-xs-12">
                        <label for="alert" class="control-label">Node alert <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">CLOUDVEX</b></label>
                        <div>
                            <textarea type="text" autocomplete="off" name="alert" class="form-control" width="100%" rows="5">{{ old('alert', $node->alert) }}</textarea>
                            <p class="text-muted"><small>Character limits: min 1, max 200 characters, leave empty to remove alert. For styling use markdown format.</small></p>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
                        <label for="daemon_text" class="control-label">Daemon text <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">CLOUDVEX</b></label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label for="container_text" class="control-label">Container text <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">CLOUDVEX</b></label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label for="node_icon" class="control-label">Node Icon <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">CLOUDVEX</b></label>
                        <div>
                    ...
                    <div class="form-group col-xs-12">
                        <label for="tier" class="control-label">Tier <b style="background-color:#17078D;font-size:1rem;padding:2px 7px;border-radius:100px;font-weight:600;">CLOUDVEX</b></label>
                        <div>
                            <select name="tier" class="form-control">
                                <option value="" {{ old('tier', $node->tier) === null ? 'selected' : '' }}>None</option>
                                <option value="budget" {{ old('tier', $node->tier) === 'budget' ? 'selected' : '' }}>Budget</option>
                                <option value="standard" {{ old('tier', $node->tier) === 'standard' ? 'selected' : '' }}>Standard</option>
                                <option value="premium" {{ old('tier', $node->tier) === 'premium' ? 'selected' : '' }}>Premium</option>
                            </select>
                        </div>
                    </div>
                    <div class="form-group col-xs-12">
