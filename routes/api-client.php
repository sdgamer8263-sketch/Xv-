...
Route::get('/extensions/eggchanger/servers/{server}', [Pterodactyl\Http\Controllers\Api\Client\EggChanger\EggChangerController::class, 'nests']);
Route::patch('/extensions/eggchanger/servers/{server}', [Pterodactyl\Http\Controllers\Api\Client\EggChanger\EggChangerController::class, 'update']);
