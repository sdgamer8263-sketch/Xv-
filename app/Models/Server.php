...
class Server extends Model implements Identifiable
{
    ...
    /**
     * Gets the subuser presets associated with a server.
     *
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Pterodactyl\Models\SubuserPreset, $this>
     */
    public function subuserPresets(): HasMany
    {
        return $this->hasMany(SubuserPreset::class, 'server_id', 'id');
    }
    ...
    /**
     * @return \Illuminate\Database\Eloquent\Relations\HasMany<\Pterodactyl\Models\Trashbin, $this>
     */
    public function trashbinItems(): HasMany
    {
